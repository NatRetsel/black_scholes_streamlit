...
class TestBlackScholes:
    ...
    def test_option_values(self, getData):
        ...
        testBlackScholes = BlackScholes(
            getData["current_underlying_price"],
            getData["dte"],
            getData["strike_price"],
            getData["risk_free_rate"],
            getData["volatility"],
            getData["price_range_to_display"],
        )
